        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                ?>
                    ...
                    <h4><?php esc_html_e( 'Import Options', 'startup-pro' ); ?></h4>
                    ...
                    <p>
                        ...
                        <a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary">
                            ...
                            <?php esc_html_e( 'Import from File', 'startup-pro' ); ?>

                        </a> 

                        <a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary">

                            <?php esc_html_e( 'Import from URL', 'startup-pro' ) ?>
                    ...
                    <div id="redux-import-code-wrapper">
                        ...
                        <p class="description" id="import-code-description">
                            ...
                            <?php echo esc_html( apply_filters( 'redux-import-file-description', __( 'Input your backup file below and hit Import to restore your sites options from a backup.', 'startup-pro' ) ) ); ?>
                    ...
                    <div id="redux-import-link-wrapper">
                        ...
                        <p class="description" id="import-link-description"><?php echo esc_html( apply_filters( 'redux-import-link-description', __( 'Input the URL to another sites options set and hit Import to load the options from that site.', 'startup-pro' ) ) ); ?></p>
                    ...
                    <p id="redux-import-action"><input type="submit" id="redux-import" name="import" class="button-primary" value="<?php esc_html_e( 'Import', 'startup-pro' ) ?>">&nbsp;&nbsp;<span><?php echo esc_html( apply_filters( 'redux-import-warning', __( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'startup-pro' ) ) ) ?></span></p>
                    ...
                    <h4><?php esc_html_e( 'Export Options', 'startup-pro' ) ?></h4>
                    ...
                    <div class="redux-section-desc">
                        ...
                        <p class="description">
                            ...
                            <?php echo esc_html( apply_filters( 'redux-backup-description', __( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'startup-pro' ) ) ) ?>
                ...
                ?>
                    ...
                    <p>
                        ...
                        <a href="javascript:void(0);" id="redux-export-code-copy" class="button-secondary"><?php esc_html_e( 'Copy Data', 'startup-pro' ) ?></a>

                        <a href="<?php echo $link; ?>" id="redux-export-code-dl" class="button-primary"><?php esc_html_e( 'Download Data File', 'startup-pro' ) ?></a>

                        <a href="javascript:void(0);" id="redux-export-link" class="button-secondary"><?php esc_html_e( 'Copy Export URL', 'startup-pro' ) ?></a>
