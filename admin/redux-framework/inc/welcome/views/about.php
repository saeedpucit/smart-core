<div class="wrap about-wrap">
    ...
    <h1><?php printf( __( 'Welcome to Redux Framework %s', 'startup-pro' ), $this->display_version ); ?></h1>



    <div

        class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'startup-pro' ), $this->display_version ); ?></div>

    <div

        class="redux-badge"><i

            class="el el-redux"></i><span><?php printf( __( 'Version %s', 'startup-pro' ), ReduxFramework::$_version ); ?></span>
    ...
    <div id="redux-message" class="updated">
        ...
        <p class="submit">
            ...
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               ...
               target="_blank"><?php _e( 'Learn More', 'startup-pro' ); ?></a>
    ...
    <div class="changelog">
        ...
        <h2><?php _e( 'New in this Release', 'startup-pro' ); ?></h2>
