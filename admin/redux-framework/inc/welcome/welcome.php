<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            ...
            echo __( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'startup-pro' );
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'startup-pro' );
        ...
        public function admin_menus() {
            ...
            $page(
                ...
                esc_html__( 'Welcome to Redux Framework', 'startup-pro' ), esc_html__( 'Redux Framework', 'startup-pro' ), $this->minimum_capability, 'redux-about', array(
            ...
            $page(
                ...
                esc_html__( 'Redux Framework Changelog', 'startup-pro' ), esc_html__( 'Redux Framework Changelog', 'startup-pro' ), $this->minimum_capability, 'redux-changelog', array(
            ...
            $page(
                ...
                esc_html__( 'Get Support', 'startup-pro' ), esc_html__( 'Get Support', 'startup-pro' ), $this->minimum_capability, 'redux-support', array(
            ...
            $page(
                ...
                esc_html__( 'Redux Extensions', 'startup-pro' ), esc_html__( 'Redux Extensions', 'startup-pro' ), $this->minimum_capability, 'redux-extensions', array(
            ...
            $page(
                ...
                esc_html__( 'The people that develop Redux Framework', 'startup-pro' ), esc_html__( 'The people that develop Redux Framework', 'startup-pro' ), $this->minimum_capability, 'redux-credits', array(
            ...
            $page(
                ...
                esc_html__( 'Redux Framework Status', 'startup-pro' ), esc_html__( 'Redux Framework Status', 'startup-pro' ), $this->minimum_capability, 'redux-status', array(
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'startup-pro' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'startup-pro' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'startup-pro' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'startup-pro' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'startup-pro' ); ?>
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'startup-pro' ), esc_html( $contributor->login ) ) )
