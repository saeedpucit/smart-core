    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'startup-pro' );
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'startup-pro' ) . '</strong>';
