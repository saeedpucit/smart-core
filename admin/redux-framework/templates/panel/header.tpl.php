<?php
    ...
    $tip_title = __( 'Developer Mode Enabled', 'startup-pro' );
    ...
    if ( $this->parent->dev_mode_forced ) {
        ...
        if ( Redux_Helpers::isWpDebug() ) {
            ...
            $debug_bit = __( 'WP_DEBUG is enabled', 'startup-pro' );
        ...
        if ( Redux_Helpers::isLocalHost() ) {
            ...
            $localhost_bit = __( 'you are working in a localhost environment', 'startup-pro' );
        ...
        if ( $is_localhost && $is_debug ) {
            ...
            $conjunction_bit = ' ' . __( 'and', 'startup-pro' ) . ' ';

        }



        $tip_msg = __( 'This has been automatically enabled because', 'startup-pro' ) . ' ' . $debug_bit . $conjunction_bit . $localhost_bit . '.';

    } else {

        $tip_msg = __( 'If you are not a developer, your theme/plugin author shipped with developer mode enabled. Contact them directly to fix it.', 'startup-pro' );
            ...
            <?php if ( isset( $this->parent->args['dev_mode'] ) && $this->parent->args['dev_mode'] ) { ?>
                ...
                <div class="redux-dev-mode-notice-container redux-dev-qtip"
                    ...
                    <span
                        ...
                        class="redux-dev-mode-notice"><?php _e( 'Developer Mode Enabled', 'startup-pro' ); ?></span>
            ...
            <?php } elseif (isset($this->parent->args['forced_dev_mode_off']) && $this->parent->args['forced_dev_mode_off'] == true ) { ?>
                ...
                <div class="redux-dev-mode-notice-container redux-dev-qtip" 
                    ...
                    <span
                        ...
                        class="redux-dev-mode-notice" style="background-color: #FF001D;"><?php _e( 'FORCED DEV MODE OFF ENABLED', 'startup-pro' ); ?></span>
