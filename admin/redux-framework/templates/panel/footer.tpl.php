...
<?php 
            ...
            if ( false === $this->parent->args['hide_save'] ) {
                ...
                submit_button( __( 'Save Changes', 'startup-pro' ), 'primary', 'redux_save', false );
            ...
            if ( false === $this->parent->args['hide_reset'] ) {
                ...
                submit_button( __( 'Reset Section', 'startup-pro' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) );

                submit_button( __( 'Reset All', 'startup-pro' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) );
...
?>
        ...
        <div class="redux-ajax-loading" alt="<?php _e( 'Working...', 'startup-pro' ) ?>">&nbsp;</div>
