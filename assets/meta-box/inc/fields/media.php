...
class RWMB_Media_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'startup-pro' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'startup-pro' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'startup-pro' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'startup-pro' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'startup-pro' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'startup-pro' ) ),
			'noTitle'            => _x( 'No Title', 'media', 'startup-pro' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => _x( 'Select Files', 'media', 'startup-pro' ),
			'uploadInstructions' => _x( 'Drop files here to upload', 'media', 'startup-pro' )
		) );
	}
