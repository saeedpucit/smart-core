...
class RWMB_Core
{
	...
	{
		$links[] = '<a href="https://metabox.io/docs/">' . __( 'Documentation', 'startup-pro' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . __( 'Extensions', 'startup-pro' ) . '</a>';
		return $links;
	}
	...
	{
		load_plugin_textdomain( 'startup-pro', false, plugin_basename( RWMB_DIR ) . '/lang/' );
	}
